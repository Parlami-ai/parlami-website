...
The mark: a speech bubble ("parlami" = Italian for "talk to me") formed by a swarm of
~90 dots — the agent team — around three rising bars: many agents, one conversation,
results going up. Dots are generated by `gen_swarm.py` (seed 42) in this folder; don't
hand-edit them, re-run the script. Colors and font come from the live site: cyan
`#22d3ee` → violet `#8b5cf6` gradient with emerald `#34d399` accents, navy `#1a1a2e`,
Quicksand Bold.
